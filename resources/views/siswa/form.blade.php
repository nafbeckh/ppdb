            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div id="data-siswa" class="content" role="tabpanel" aria-labelledby="data-siswa-trigger">
                <div class="row">
                  ...
                  <div class="col-sm">
                    <div class="form-group">
                      <img class="img-pasfoto mt-1 mb-2">

                      <div class="custom-file">
                        <input type="file" class="custom-file-input @error('pasfoto') is-invalid @enderror" name="pasfoto" id="foto">
                        <label class="custom-file-label" for="exampleInputFile">Pilih Pas Foto</label>
                        
                        @error('pasfoto')
                        <span id="pasfoto-error" class="error invalid-feedback">
                          {{ $message }}
                        </span>
                        @enderror
                      </div>
                ...
                <script>
                  $('#foto').change(function () {
                      ...
                      reader.onloadend = function () {
                        $('.img-pasfoto').attr('src', `${reader.result}`);
                      }
                      if (file) {
